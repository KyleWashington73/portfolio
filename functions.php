...
function portfolio_scripts() {
	...
	wp_enqueue_script( 'portfolio-slider', get_template_directory_uri() . '/js/slider.js', array(), _S_VERSION, true );
...
function my_theme_scripts() {
    wp_enqueue_script( 'my-great-script', get_template_directory_uri() . '/js/slider.js', array( 'jquery' ), '1.0.0', true );
}
add_action( 'wp_enqueue_scripts', 'portfolio_scripts' );
